...
def resolve_repo_name(root: Path) -> str:
    ...
    # https://github.com/soia-team/soia-open-edu-course-skills.git  -> soia-open-edu-course-skills
    # git@github.com:soia-team/soia-open-edu-course-skills.git       -> soia-open-edu-course-skills
    tail = url.rstrip("/")
    for sep in ("/", ":"):
        if sep in tail:
