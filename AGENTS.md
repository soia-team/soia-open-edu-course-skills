...
```bash
npx skills add soia-team/soia-open-edu-course-skills -g -a '*' -s <new-skill-name> -y
```
...
```bash
npx skills add soia-team/soia-open-edu-course-skills -g -a '*' -s <new-name-1> -s <new-name-2> -y
```
