...
|---|---|---|---|
| Config | `${XDG_CONFIG_HOME:-~/.config}/soia-skills/soia-open-edu-course-skills/...` | same unless the host integration deliberately uses the native app-support directory | `%APPDATA%\soia-skills\soia-open-edu-course-skills\...` |
| State | `${XDG_STATE_HOME:-~/.local/state}/soia-skills/soia-open-edu-course-skills/...` | same | `%LOCALAPPDATA%\soia-skills\soia-open-edu-course-skills\state\...` |
| Cache | `${XDG_CACHE_HOME:-~/.cache}/soia-skills/soia-open-edu-course-skills/...` | `~/Library/Caches/soia-skills/soia-open-edu-course-skills/...` | `%LOCALAPPDATA%\soia-skills\soia-open-edu-course-skills\Cache\...` |
